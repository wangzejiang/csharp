...
　　                                          int hwndChildAfter, // handle to child window
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            hwnd = FindWindowEx(hwnd, 0, "NativeHWNDHost", "TaskManagerMain");
            hwnd = FindWindowEx(hwnd, 0, "DirectUIHWND", null);

            int tmp = FindWindowEx(hwnd, 0, "CtrlNotifySink", null);
            tmp = FindWindowEx(hwnd, tmp, "CtrlNotifySink", null);
            tmp = FindWindowEx(hwnd, tmp, "CtrlNotifySink", null);
            hwnd = FindWindowEx(hwnd, tmp, "CtrlNotifySink", null);
